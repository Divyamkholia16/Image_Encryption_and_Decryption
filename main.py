...
#entry of key 
keytitle = Label(root, text="Key : ", 
                 bg="green",font = 10, width=13)
...
browsebutton = Button(root, text ="Browse", 
                      command = open_file,font = 20 ,height=1, width=9 , bg="#A9A9A9")


#encrypt Button 
encryptButton = Button(root, text ="Encrypt", 
                      command = encryption,font = 20 ,height=1, width=9, bg="#A9A9A9")


#decrypt Button 
decryptButton = Button(root, text ="Decrypt", 
                      command = decryption,font = 20 ,height=1, width=9 , bg="#A9A9A9")
